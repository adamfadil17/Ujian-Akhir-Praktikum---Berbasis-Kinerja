...
public class Sapi extends Hewan implements TreatmentInterface {
    ...
    public double dailySell(){
        return getQuantity()* getMilkInLitrePerDay() * getMilkPrice();
    }
    ...
    @Override public String toString(){
        ...
        return "Nama         :\t" + super.getName() + "\n" +
                "Jumlah      :\t" + super.getQuantity() + " ekor" + "\n" +
                "Pengeluaran :\t" + "Rp. " + super.getTotalExpense() + " (per hari)" + "\n" +
                "Susu/hari   :\t" + getMilkInLitrePerDay() + " liter (per ekor)" + "\n" +
                "Harga Susu  :\t" + "Rp. " + getMilkPrice() + " (per butir)" + "\n" +
